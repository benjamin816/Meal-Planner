...
// Fix: Modified LoadingIcon to accept and spread SVG props, specifically to allow 'className' overrides
export const LoadingIcon = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
    <svg className={`animate-spin text-current ${className || 'h-5 w-5'}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" {...props}>
