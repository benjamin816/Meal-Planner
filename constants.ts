...
export const DEFAULT_ALL_TAGS: Record<RecipeCategory, RecipeTag[]> = {
    [RecipeCategory.Breakfast]: ['high protein', 'easy to cook', 'on-the-go', 'storebought'],
    [RecipeCategory.Dinner]: ['affordable', 'high protein', 'easy to cook', 'storebought'],
    [RecipeCategory.Snack]: ['low cal', 'high protein', 'on-the-go', 'storebought'],
    [RecipeCategory.Drink]: ['low cal', 'easy to cook', 'storebought'],
};
...
export const INITIAL_RECIPES: Recipe[] = [
    ...
    },
    {
        ...
        instructions: '1. Cook rice as per package instructions.\n2. Brown beef.\n3. Add garlic/ginger.\n4. Stir in soy sauce and sugar.\n5. Serve beef over rice with steamed broccoli.',
    ...
    },
    {
        ...
        instructions: '1. Cook rice.\n2. Slow cook chicken with salsa.\n3. Shred chicken.\n4. Assemble with rice, beans and corn.',
    ...
    },
    {
        ...
        instructions: '1. Cook rice and let cool.\n2. Scramble egg.\n3. Cook chicken.\n4. Stir fry veg and rice.\n5. Combine all with soy sauce.',
    ...
    {
        id: 'r_10',
        name: 'Quick Protein Pasta with Frozen Turkey Meatballs',
        description: 'Lentil pasta and lean frozen turkey meatballs.',
        category: RecipeCategory.Dinner,
        tags: [],
        ingredients: '2 oz Dry chickpea or lentil pasta\n5-6 frozen pre-cooked turkey meatballs\n1/2 cup marinara sauce\n1 tbsp grated parmesan cheese\nFresh basil or parsley',
        instructions: '1. Boil pasta for 7-9 mins.\n2. Heat meatballs and sauce in saucepan.\n3. Simmer for 10-12 mins.\n4. Combine and serve.',
        macros: { calories: 520, protein: 44, carbs: 58, fat: 16 },
        healthScore: 8.2,
    ...
    },
    {
        ...
        tags: ['storebought', 'on-the-go'],
        ingredients: 'Kirkland Signature Greek Yogurt Cup - 1 serving',
    ...
    },
    {
        ...
        category: RecipeCategory.Snack,
        tags: ['storebought', 'on-the-go'],
        ingredients: 'Kirkland Signature Cottage Cheese Cup - 1 serving',
        instructions: '1. Eat cold.',
    ...
    },
    {
        ...
        healthScore: 6.2,
        scoreReasoning: 'High sodium from cereal grain, but good protein.',
        usageIntensity: 'light',
        servings: 1
    },
    {
    ...
    {
        id: 'r_25',
        name: 'Kirkland Signature Bacon & Gouda Egg Bites',
        description: 'Smoky, cheesy sous-vide style egg bites.',
        category: RecipeCategory.Breakfast,
        tags: ['storebought', 'high protein'],
        ingredients: 'Kirkland Signature Bacon & Gouda Egg Bites - 1 serving',
        instructions: '1. Remove from packaging. 2. Microwave on high for 60-90 seconds OR Air fry at 400F for 5-8 mins OR Oven bake at 400F for 8-10 mins. 3. Cool 1 min.',
        macros: { calories: 310, protein: 22, carbs: 4, fat: 24 },
        healthScore: 7.2,
        scoreReasoning: 'Good protein, moderate fat.',
        usageIntensity: 'normal',
        servings: 1
    },
    {
        id: 'r_26',
        name: 'High-Protein Kodiak Cakes with Cottage Cheese & Berry Compote',
        description: 'Quick protein-packed pancakes with a yogurt-cheese whip.',
        category: RecipeCategory.Breakfast,
        tags: ['high protein', 'easy to cook'],
        ingredients: 'Kodiak Power Cakes Flapjack & Waffle Mix - 1 serving\n1 large egg\n1/3 cup water\n1/2 cup low-fat cottage cheese\n1/2 cup frozen mixed berries',
        instructions: '1. Mix Kodiak, egg, and water. 2. Cook on greased skillet until bubbles pop, then flip. 3. Microwave berries for 45-60s until saucy. 4. Plate pancakes with cottage cheese and berries.',
        macros: { calories: 380, protein: 32, carbs: 38, fat: 8 },
        healthScore: 9.0,
    ...
    },
    {
        ...
        category: RecipeCategory.Snack,
        tags: ['storebought', 'on-the-go'],
        ingredients: 'David Bar Cookie Dough - 1 serving',
    ...
    {
        id: 'r_28',
        name: 'Kirkland Signature Grass-Fed Beef Stick',
        description: 'High-protein grass-fed beef snack.',
        category: RecipeCategory.Snack,
        tags: ['storebought', 'high protein', 'on-the-go'],
        ingredients: 'Kirkland Signature Grass-Fed Beef Stick - 1 serving',
        instructions: '1. Remove from individual wrapper. 2. Consume immediately.',
        macros: { calories: 100, protein: 10, carbs: 1, fat: 7 },
        healthScore: 8.0,
        scoreReasoning: 'Clean protein snack.',
        usageIntensity: 'light',
        servings: 1
    }
];
